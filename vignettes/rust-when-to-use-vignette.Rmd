...
\end{eqnarray}
$$
$x =(x_1, \ldots, x_d)$, $\chi_i^- = \{ x \in \chi, x_i \leq 0 \}$ and $\chi_i^+ = \{ x \in \chi, x_i \geq 0 \}$.  See the vignette [Introducing rust](rust-vignette.html) for more details.
...
For $r = 1$ the algorithm find essentially the correct values of $b_1^-$ and $b_1^*$ even though these do not occur at a turning point of the objective functions.  The estimated probability of acceptance is indeed larger for $r = 1.26$.
